 ...
 */
fun Activity.askPermissions(vararg permissions: String, callbacks: PermissionCallbackConfig.() -> Unit) {

    val permissionCallbacks: PermissionCallbacks = PermissionCallbackConfig().apply { callbacks() }
